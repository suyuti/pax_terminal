// 8583.cpp: implementation of the C8583 class.
//
//////////////////////////////////////////////////////////////////////
...
FIELD_ATTR C8583::ms_fieldDef[] =
{
	...
	{Attr_UnUsed, Attr_fix, 0},				// 23 - not used
	//{Attr_n, Attr_fix, LEN_PAN_SEQ_NO},	// 23 - PAN Seq #
	{Attr_UnUsed, Attr_fix, 0},				// 24 - not used
	//{Attr_n, Attr_fix, LEN_NII},			// 24 - NII
	{Attr_UnUsed, Attr_fix, 0},				// 25 - not used
	...
	{Attr_n, Attr_fix,  LEN_CURCY_CODE},	// 49 - Transaction Currency code
...
FIELD_ATTR C8583::ms_recFieldDef[] =
{
	{Attr_n, Attr_fix,  LEN_MSG_CODE},		// message code(MTI)
	{Attr_b, Attr_fix,  LEN_BITMAP},		// 1 - bitmap
	{Attr_n, Attr_var1, LEN_PAN},			// 2 - PAN
...
FIELD_ATTR C8583::ms_TMSFieldDef[] =
{
	{Attr_n, Attr_fix,  LEN_MSG_CODE},		// message code(MTI)
	{Attr_b, Attr_fix,  LEN_BITMAP},		// 1 - bitmap
	...
	{Attr_n, Attr_fix, LEN_STAN},			// 11 - STAN
	{Attr_UnUsed, Attr_fix, 0},				// 12 - not used
	//{Attr_n, Attr_fix, LEN_LOCAL_TIME},	// 12 - local time
	{Attr_UnUsed, Attr_fix, 0},				// 13 - not used
	//{Attr_n, Attr_fix, LEN_LOCAL_DATE},	// 13 - local date
	...
	{Attr_UnUsed, Attr_fix, 0},				// 39 - response code
	//{Attr_a, Attr_fix,  LEN_RSP_CODE},		// 39 - response code
	{Attr_UnUsed, Attr_fix, 0},				// 40 - not uesed
	{Attr_a, Attr_fix, LEN_TERM_ID},		// 41 - TID
	{Attr_a, Attr_fix, LEN_MERCHANT_ID},	// 42 - MID
	{Attr_a, Attr_fix, LEN_F43},			// 43 - SERIAL + POSVER + BATCH
	//{Attr_UnUsed, Attr_fix, 0},				// 43 - not used
	...
	{Attr_UnUsed, Attr_fix, 0},				// 58 - not used
	{Attr_UnUsed, Attr_fix, 0},				// 59 - not used
	{Attr_UnUsed, Attr_fix, 0},				// 60 - Private used
	//{Attr_b, Attr_var2, LEN_TMSFIELD60},	// 60 - Private used
	//{Attr_UnUsed, Attr_fix, 0},				// 61 - POS SN/desc code
	{Attr_b, Attr_var2, LEN_FIELD61},		// 61 - POS SN/desc code
...
FIELD_ATTR C8583::ms_recTMSFieldDef[] =
{
	{Attr_n, Attr_fix,  LEN_MSG_CODE},		// message code(MTI)
	{Attr_b, Attr_fix,  LEN_BITMAP},		// 1 - bitmap
	{Attr_UnUsed, Attr_fix, 0},				// 2 - PAN
	...
	{Attr_UnUsed, Attr_fix, 0},				// 40 - not uesed
	{Attr_a, Attr_fix, LEN_TERM_ID},		// 41 - TID
	{Attr_UnUsed, Attr_fix, 0},				// 42 - MID
	{Attr_UnUsed, Attr_fix, 0},				// 43 - SERIAL + POSVER + BATCH
	{Attr_UnUsed, Attr_fix, 0},				// 44 - Add'l rsp data
	{Attr_UnUsed, Attr_fix, 0},				// 45 - track 1
	{Attr_UnUsed, Attr_fix, 0},				// 46 - not used
	{Attr_UnUsed, Attr_fix, 0},				// 47 - not used
...
//-------------------------------------------------------------------
// Advice 
FIELD_ATTR C8583::ms_advFieldDef[] =
{
	{Attr_n,		Attr_fix,	LEN_MSG_CODE},		//  message code(MTI)
	{Attr_b,		Attr_fix,	LEN_BITMAP},		//  1 - bitmap
	{Attr_n,		Attr_var1,	LEN_PAN},			//  2 - PAN
	...
	{Attr_UnUsed,	Attr_fix,	0},					// 10 - not used
	{Attr_n,		Attr_fix,	LEN_STAN},			// 11 - STAN
	{Attr_n,		Attr_fix,	LEN_LOCAL_TIME},	// 12 - not used
	{Attr_n,		Attr_fix,	LEN_LOCAL_DATE},	// 13 - not used
	{Attr_n,		Attr_fix,	LEN_EXP_DATE},		// 14 - expire
	{Attr_UnUsed,	Attr_fix,	0},					// 15 - not used
	{Attr_UnUsed,	Attr_fix,	0},					// 16 - not used
	{Attr_UnUsed,	Attr_fix,	0},					// 17 - not used
	{Attr_n,		Attr_fix,	LEN_MCC},			// 18 - MCC
	{Attr_UnUsed,	Attr_fix,	0},					// 19 - not used
	{Attr_UnUsed,	Attr_fix,	0},					// 20 - not used
	{Attr_UnUsed,	Attr_fix,	0},					// 21 - not used
	{Attr_n,		Attr_fix,	LEN_ENTRY_MODE},	// 22 - entry modes
	...
	{Attr_UnUsed,	Attr_fix,	0},					// 47 - not used
	{Attr_UnUsed,	Attr_fix,	0},					// 48 - add'l req data
	{Attr_n,		Attr_fix,	LEN_CURCY_CODE},	// 49 - FRN Curcy code
	{Attr_UnUsed,	Attr_fix,	0},					// 50 - Currency code
	{Attr_UnUsed,	Attr_fix,	0},					// 51 - not used
	{Attr_UnUsed,	Attr_fix,	0},					// 52 - PIN data
	{Attr_UnUsed,	Attr_fix,	0},					// 53 - not used
...
FIELD_ATTR C8583::ms_recAdvFieldDef[] =
{
	{Attr_n,		Attr_fix,	LEN_MSG_CODE},		//  message code(MTI)
	{Attr_b,		Attr_fix,	LEN_BITMAP},		//  1 - bitmap
	{Attr_UnUsed,	Attr_var1,	0},					//  2 - PAN
	{Attr_n,		Attr_fix,	LEN_PROC_CODE},		//  3 - process code
	{Attr_n,		Attr_fix,	LEN_TRAN_AMT},		//  4 - txn amount
	{Attr_UnUsed,	Attr_fix,	0},					//  5 - Foreign Amt(DCC)
	{Attr_UnUsed,	Attr_fix,	0},					//  6 - not used
	...
	{Attr_UnUsed,	Attr_fix,	0},					// 36 - track 3
	{Attr_a,		Attr_fix,	LEN_RRN},			// 37 - RRN
	//{Attr_n,		Attr_fix,	LEN_AUTH_CODE},		// 38 - auth. code
	{Attr_UnUsed,	Attr_fix,	0},					// 38 - auth. code
	{Attr_a,		Attr_fix,	LEN_RSP_CODE},		// 39 - response code
	{Attr_UnUsed,	Attr_fix,	0},					// 40 - not uesed
	//{Attr_UnUsed,	Attr_fix,	0},					// 40 - not uesed
...
//-------------------------------------------------------------------
FIELD_ATTR C8583::ms_OnlineFieldDef[] =
{
	{Attr_n,		Attr_fix,	LEN_MSG_CODE},		//  message code(MTI)
	{Attr_b,		Attr_fix,	LEN_BITMAP},		//  1 - bitmap
	{Attr_n,		Attr_var1,	LEN_PAN},			//  2 - PAN
...
FIELD_ATTR C8583::ms_recOnlineFieldDef[] =
{
	{Attr_n,		Attr_fix,	LEN_MSG_CODE},		//  message code(MTI)
	{Attr_b,		Attr_fix,	LEN_BITMAP},		//  1 - bitmap
	{Attr_UnUsed,	Attr_var1,	0},					//  2 - PAN
...
FIELD_ATTR C8583::ms_settleFieldDef[] =
{
	{Attr_n,		Attr_fix,	LEN_MSG_CODE},		//  message code(MTI)
	{Attr_b,		Attr_fix,	LEN_BITMAP},		//  1 - bitmap
	{Attr_UnUsed,	Attr_var1,	0},					//  2 - PAN
...
FIELD_ATTR C8583::ms_recSettleFieldDef[] =
{
	{Attr_n,		Attr_fix,	LEN_MSG_CODE},		//  message code(MTI)
	{Attr_b,		Attr_fix,	LEN_BITMAP},		//  1 - bitmap
	{Attr_UnUsed,	Attr_var1,	0},					//  2 - PAN
...
FIELD_ATTR C8583::ms_voidFieldDef[] =
{
	{Attr_n,		Attr_fix,	LEN_MSG_CODE},		//  message code(MTI)
	{Attr_b,		Attr_fix,	LEN_BITMAP},		//  1 - bitmap
	{Attr_n,		Attr_var1,	LEN_PAN},			//  2 - PAN
...
FIELD_ATTR C8583::ms_recVoidFieldDef[] =
{
	{Attr_n,		Attr_fix,  LEN_MSG_CODE},		// message code(MTI)
	{Attr_b,		Attr_fix,  LEN_BITMAP},		// 1 - bitmap
	{Attr_UnUsed,	Attr_var1,	0},					//  2 - PAN
...
FIELD_ATTR C8583::ms_refundFieldDef[] =
{
	{Attr_n,		Attr_fix,	LEN_MSG_CODE},		//  message code(MTI)
	{Attr_b,		Attr_fix,	LEN_BITMAP},		//  1 - bitmap
	{Attr_n,		Attr_var1,	LEN_PAN},			//  2 - PAN
	...
	{Attr_UnUsed,	Attr_fix,	0},					// 60 - Private used
	{Attr_UnUsed,	Attr_fix,	0},					// 61 - POS SN/desc code
	{Attr_b,		Attr_var2,	LEN_FIELD62},		// 63 - Private used
	{Attr_UnUsed,	Attr_fix,	0},					// 62 - ROC/SOC
	{Attr_UnUsed,	Attr_fix,	0},					// 64 - MAC(not used)
	{Attr_Over,		Attr_fix,	0}
};

FIELD_ATTR C8583::ms_recRefundFieldDef[] =
{
	{Attr_n,		Attr_fix,	LEN_MSG_CODE},		//  message code(MTI)
	{Attr_b,		Attr_fix,	LEN_BITMAP},		//  1 - bitmap
	{Attr_UnUsed,	Attr_var1,	0},					//  2 - PAN
...
int C8583::Pack(FIELD_ATTR *pDataAttr, void *pSt8583, uchar *pusOut, uint *puiOutLen)
{
	int     iRet;
...
int C8583::Unpack(FIELD_ATTR *pDataAttr, uchar *pusIn, uint uiInLen, void *pSt8583)
{
	int     iRet;
...
/****************************************************************************
 ...
 Return Code:
    ...
    < 0             length overflow
****************************************************************************/
int C8583::PackElement(FIELD_ATTR *pAttr, uchar *pusIn, uchar *pusOut, uint *puiOutLen)
{
...
/****************************************************************************
 ...
 Return Code:
    ...
    < 0             length overflow
****************************************************************************/
int C8583::UnPackElement(FIELD_ATTR *pAttr, uchar *pusIn, uchar *pusOut, uint *puiInLen)
{

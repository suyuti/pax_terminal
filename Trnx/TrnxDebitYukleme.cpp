...
CTrnxDebitYukleme::CTrnxDebitYukleme() :
	CTrnxOnline((CEngine*)NULL)
{
	strncpy(this->m_trnxLabel, TRNX_DEBIT_YUKLEME, strlen(TRNX_DEBIT_YUKLEME));
	sprintf(this->m_inputTypeLabel, "Bk. Yukleme");
	this->m_data.m_trnxType = CTrnxFactory::trnxDebitYukleme;
}

//--------------------------------------------------------------------------------------------------

CTrnxDebitYukleme::CTrnxDebitYukleme(CEngine* pEng) : 
	CTrnxOnline(pEng)
{
	strncpy(this->m_trnxLabel, TRNX_DEBIT_YUKLEME, strlen(TRNX_DEBIT_YUKLEME));
	this->m_data.m_trnxType = CTrnxFactory::trnxDebitYukleme;
...
void CTrnxDebitYukleme::PrintBody()
{
	char tmp[100] = "";
	char tmp2[100] = "";
...
int CTrnxDebitYukleme::OnApproved()
{
